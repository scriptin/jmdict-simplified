...
object XrefSerializer : KSerializer<JMdictSimplified.Xref> {
    override val descriptor: SerialDescriptor = buildClassSerialDescriptor("Xref")

    override fun serialize(encoder: Encoder, value: JMdictSimplified.Xref) {
    ...
    override fun deserialize(decoder: Decoder): JMdictSimplified.Xref {
        ...
        return if (size == 1) {
            JMdictSimplified.Xref(part1, null, null)
        } else if (size == 2) {
            if (array.jsonArray[1].jsonPrimitive.isString) {
                JMdictSimplified.Xref(part1, array.jsonArray[1].jsonPrimitive.content, null)
            } else {
                try {
                    JMdictSimplified.Xref(part1, null, array.jsonArray[1].jsonPrimitive.content.toInt())
            ...
            JMdictSimplified.Xref(part1, part2, index)
        } else {
